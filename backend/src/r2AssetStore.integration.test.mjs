...
test('R2 adapter regression: no production binding and existing security/Brain routing stay intact', () => {
  assert.match(typesSource, /ASSET_BUCKET\?: R2Bucket/)
  assert.doesNotMatch(wranglerSource, /\[\[r2_buckets\]\]/)
  assert.match(wranglerSource, /R2 binding is intentionally absent/)
