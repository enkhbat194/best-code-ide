...
export const missionExecutionMutationTools = [
  ...
  ['mission_task_result_submit', {
    ...
    ...leaseProof,
    result: object,
    delivery_operation_id: id,
    expected_commit_sha: { type: 'string', pattern: '^[a-fA-F0-9]{40,64}$' },
    draft_pr_number: { type: 'integer', minimum: 1 },
  }, ['task_id', 'lease_id', 'fencing_token', 'result']],
